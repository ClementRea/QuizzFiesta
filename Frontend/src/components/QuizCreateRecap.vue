<template>
  <div class="summary-step">
    <div class="row items-center q-mb-lg">
      <q-icon name="summarize" size="28px" class="text-secondary q-mr-sm" />
      <h2 class="text-h5 text-weight-medium q-ma-none text-secondary">Récapitulatif</h2>
    </div>

    <q-banner class="bg-positive text-white rounded-borders q-mb-md" v-if="isFormValid">
      ...
      <div class="col-12">
        <q-card class="summary-info-card" flat bordered>
          ...
          <q-card-section class="q-pa-md">
            <div class="summary-item q-mb-md" v-if="logoPreviewUrl">
              <q-img
                :src="logoPreviewUrl"
            ...
            <div class="summary-item q-mb-md">
              <div class="text-caption text-secondary text-uppercase text-weight-bold">Titre</div>
              <div class="text-body1 text-weight-medium">{{ quizData.title }}</div>
            </div>
            <div class="summary-item q-mb-md">
              <div class="text-caption text-secondary text-uppercase text-weight-bold">
                Description
              </div>
